                ...
                <div class="flex flex-col rounded-3xl p-8 gap-8 bg-white">
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <div class="flex flex-col rounded-xl border border-[#E6E7EB]">
                            <p class=" py-7 px-8 w-full font-semibold text-lg leading-[27px]">Transfer Bank</p>
                            <hr class="border-[#E6E7EB]">
                            <div class="flex flex-col py-5 px-8 gap-8">
                            <div class="flex items-center justify-between gap-8">
                                    <div class="flex w-[78px] h-[53px] shrink-0 overflow-hidden">
                                        <img src="{{asset('assets/images/logos/mandiri.svg')}}" class="object-contain" alt="bank logo">
                                    </div>
                                    <div class="flex flex-col gap-[2px] w-full">
                                        <p class="font-medium text-aktiv-grey">Mandiri (persero)</p>
                                        <p class="font-semibold text-lg leading-[27px]">435765123544</p>
                                    </div>
                                ...
                                <div class="flex items-center justify-between gap-8">
                                    ...
                                    <div class="flex flex-col gap-[2px] w-full">
                                        <p class="font-medium text-aktiv-grey">Bank Central Asia</p>
                                        <p class="font-semibold text-lg leading-[27px]">435765123544</p>
                                    </div>
                                ...
                                <div class="flex items-center justify-between gap-8">
                                    ...
                                    <div class="flex flex-col gap-[2px] w-full">
                                        <p class="font-medium text-aktiv-grey">Bank Negara Indonesia (persero)</p>
                                        <p class="font-semibold text-lg leading-[27px]">980345786789</p>
                                    </div>
                                ...
                                <div class="flex items-center justify-between gap-8">
                                    ...
                                    <div class="flex flex-col gap-[2px] w-full">
                                        <p class="font-medium text-aktiv-grey">Bank Rakyat Indonesia (persero)</p>
                                        <p class="font-semibold text-lg leading-[27px]">43654676576534</p>
                                    </div>
                    ...
                    <div class="flex flex-col gap-4">
                        <h2 class=" text-aktiv-grey leading-[27.5px]">Upload Proof of payment</h2>
                        <label class="flex flex-col gap-4">
